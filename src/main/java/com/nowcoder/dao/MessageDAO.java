...
public interface MessageDAO {
    ...
    @Select({"select count(id) from ", TABLE_NAME, "where has_read=0 and usere_id=#{userId} and conversation_id=#{conversationId}"})
    ...
    List<Message> getConversationList(@Param("userId") int userId, int offset, @Param("limit")int limit);
